...
public class VLSM extends Subnetting {
    ...
    public void FindSubredMask() {
        for (int q = 0; q < listPrefix.size(); q++) {
            ...
            int fourthOctetValue = Integer.parseInt(splitSubredZeroAndOne[3], 2);
    ...
    public void FindRedIP() {
        ...
        while (w < listSubredMask.size()) {
            ...
            for (int i = 0; i < 4; i++) {
                octets[i] = Integer.parseInt(splitRedIP[i]);
            }
            ...
            String newNet = octets[0] + "." + octets[1] + "." + octets[2] + "." + octets[3];
